 ...
 */
class AlbertContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'newsletter_manager' => 'getNewsletterManagerService',
        );
    ...
    {
        return $this->services['mailer'] = new \Mailer('transport');
    }

    /**
     * Gets the 'newsletter_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \NewsletterManager A NewsletterManager instance
     */
    protected function getNewsletterManagerService()
    {
        $this->services['newsletter_manager'] = $instance = new \NewsletterManager();

        $instance->setMailer(${($_ = isset($this->services['mailer']) ? $this->services['mailer'] : $this->get('mailer')) && false ?: '_'}, $this->getEnv('USER'));
